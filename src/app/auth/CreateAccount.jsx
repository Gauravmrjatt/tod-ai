  ...
  return (
    <div className="min-h-screen flex items-center justify-center  px-4">
      <div className="w-full max-w-md">
        ...
        <form
          onSubmit={handleSubmit(data => { mutate({...data, userType : "parent"}); setApiError(""); console.log(data) })}
          className="space-y-6"
        >
          {apiError && (
          ...
          <div className="space-y-2">
            <Input
              ...
              className="h-14 bg-[#f3f4f6] border-0 focus-visible:ring-1 focus-visible:ring-[#1798e8]"
            />
            {errors.name && (
          ...
          {/* <div className="space-y-2 display-none">
            <select
              {...register("userType")}
              className="h-14 bg-[#f3f4f6] border-0 focus-visible:ring-1 focus-visible:ring-[#1798e8] w-full rounded-sm dark:bg-input/30"
            >
              <option  defaultValue="parent">Parent</option>
            </select>
            {errors.userType && (
          ...
          {userType === "child" && (
            <div className="space-y-2 h-14 bg-[#f3f4f6] border-0 focus-visible:ring-1 focus-visible:ring-[#1798e8]">
              <Input
                {...register("parentId")}
                type="text"
          ...
          <Button
            type="submit"
            className="w-full h-14 bg-[#1798e8] hover:bg-[#1279b9] text-white"
            disabled={isPending}
          >
